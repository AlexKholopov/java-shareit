...
public interface BookingRepository extends PagingAndSortingRepository<Booking, Long> {
    ...
    Page<Booking> findByItem_Owner(User owner, Pageable pageable);

    Page<Booking> findByItem_OwnerAndStartBeforeAndEndAfter(User owner, LocalDateTime start, LocalDateTime end, Pageable pageable);

    Page<Booking> findByItem_OwnerAndEndBefore(User owner, LocalDateTime end, Pageable pageable);

    Page<Booking> findByItem_OwnerAndStartAfter(User owner, LocalDateTime start, Pageable pageable);

    Page<Booking> findByItem_OwnerAndStatus(User owner, Status status, Pageable pageable);
